...
exports.getExercises = async (req, res, next) => {
  ...
  if(totalFiltered > 0){
    exercises.forEach((exercise,index) =>{
      ...
      nestedData['options'] += '<li><a onclick="uploadVideo(this)" data-id = "'+exercise.id+'" class="dropdown-item main-text" href="#"><i class="fa fa-play"></i>Videos</a></li>';
...
exports.getExerciseVideos = async (req, res, next) => {
  ...
  if(totalFiltered > 0){
    videos.forEach((video,index) =>{
      ...
      nestedData['image'] = '<video controls class="controls img-responsive" controls controlsList="nodownload" webkittallowfullscreen mozallowfullscreen allowfullscreen poster="/uploads/video/exercise/thumbnail_image/thumb/'+video.thumb_image+'">';
